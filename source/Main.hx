...
class Main extends Sprite {
	...
	private function init(?E:Event):Void  {
		...
		Lib.current.stage.scaleMode = StageScaleMode.NO_SCALE;
			...
			var stageWidth:Int = cast Math.min(Capabilities.screenResolutionX, Capabilities.screenResolutionY);
			var stageHeight:Int = cast Math.max(Capabilities.screenResolutionX, Capabilities.screenResolutionY);
		#else
